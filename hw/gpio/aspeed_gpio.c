...
static void aspeed_gpio_realize(DeviceState *dev, Error **errp)
{
    ...
    qdev_init_gpio_out(dev, &s->gpios[0][0], ASPEED_GPIO_MAX_NR_SETS * ASPEED_GPIOS_PER_SET);
    qdev_init_gpio_in(dev, aspeed_gpio_set,  ASPEED_GPIO_MAX_NR_SETS * ASPEED_GPIOS_PER_SET);
